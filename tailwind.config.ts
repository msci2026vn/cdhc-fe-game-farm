  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "match-ring": {
          "0%": { transform: "scale(0.3)", opacity: "1", borderWidth: "3px" },
      ...
      animation: {
        ...
        "gem-pop": "gem-pop 0.35s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "gem-land": "gem-land 0.3s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
        "gem-swap": "gem-swap 0.25s ease-out",
        "match-ring": "match-ring 0.5s ease-out forwards",
