  ...
  return (
    <div className="min-h-screen farm-sky-gradient flex flex-col items-center justify-center px-6">
      ...
      <button
        ...
        className="animate-slide-up w-full max-w-[300px] flex items-center justify-center gap-3 bg-card hover:bg-muted text-foreground font-semibold py-4 px-6 rounded-2xl shadow-lg border border-border transition-all active:scale-95"
      >
