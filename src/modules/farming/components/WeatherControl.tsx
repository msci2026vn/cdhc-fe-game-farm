            ...
            <div className="px-6 py-4 flex justify-between items-center bg-gradient-to-r from-[#1e3799] to-[#0984e3]">
              <div className="flex flex-col">
                <h3 className="font-heading text-lg font-bold text-white flex items-center gap-2">
                  🌤️ {t('farming.weather.summary')}
                </h3>
                <span className="text-[10px] text-white/80 font-medium uppercase tracking-wider">{t('farming.weather.auto_sync')}</span>
              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4 bg-blue-50/50 p-4 rounded-2xl border border-blue-100">
                ...
                <div className="flex-1">
                  <div className="text-[10px] font-bold text-blue-600 uppercase mb-0.5">{location.province || t('farming.weather.current_location')}</div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-[10px] font-bold text-slate-400 uppercase leading-none">{t('farming.weather.temperature')}</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-50 p-3 rounded-xl flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] font-bold text-slate-400 uppercase leading-none mb-1">{t('farming.weather.humidity')}</div>
                ...
                <div className="bg-slate-50 p-3 rounded-xl flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] font-bold text-slate-400 uppercase leading-none mb-1">{t('farming.weather.wind')}</div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">⏰ {t('farming.weather.time_cycle')}</p>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">🌦️ {t('farming.weather.weather_type')}</p>
              ...
              <div className="rounded-2xl p-4 flex items-center justify-between bg-slate-100 border border-slate-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">{t('farming.weather.updated_at')}</span>
                </div>
