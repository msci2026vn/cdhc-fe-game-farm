  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
      <div className="bg-gray-800 rounded-2xl p-8 text-center max-w-sm mx-4">
        ...
        <h2 className="text-2xl font-bold text-yellow-400 mb-2">{t('world_boss.display.boss_defeated')}</h2>
        <p className="text-gray-300 mb-4">{t('world_boss.display.calculating_rewards')}</p>
