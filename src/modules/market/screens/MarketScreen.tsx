...
// Commodity icon mapping (Material Symbols) by commodityId
...
export default function MarketScreen() {
  ...
  return (
    <div className="max-w-md mx-auto h-screen flex flex-col relative bg-gradient-to-b from-[#dcedc8] to-[#aed581] shadow-2xl overflow-hidden select-none">
      ...
      {/* ── Scrollable body ── */}
      <div className="flex-1 overflow-y-auto px-4 py-2 space-y-4 relative z-10 pb-4" style={{ scrollbarWidth: 'none' }}>

        {/* Composite Index — wood panel */}
        <div
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="font-bold text-[#5d4037]">{p.name || p.commodityId}</span>
                        <span className="text-xs text-gray-500 font-mono">{p.commodityId}</span>
                      </div>
                    </div>
